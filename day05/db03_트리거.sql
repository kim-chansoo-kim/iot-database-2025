-- 트리거
-- 시작전 설정 변경
SET GLOBAL log_bin_trust_function_creators=ON; -- 다음버전 MySQL에서는 사라질 예정(DEprecated)
...
-- 트리거 생성
-- UPDATE나 DELETE 시에는 컬럼을 old. 라고 사용 ex) AFTER UPDATE ON 테이블명.....VALUES(old.bookid, ...)
